...
export function EmptyStateParameterRequired({ paramName }: EmptyStateParameterRequiredProps) {
  return (
    <div className="p-12 text-center bg-blue-50 rounded-lg border border-blue-200">
      ...
      <h2 className="text-xl font-semibold mb-2">Parâmetro necessário</h2>
      <p className="text-blue-700 mb-6">
        Por favor, forneça um &ldquo;{paramName}&rdquo; para visualizar.
      </p>
    </div>
  );
} 